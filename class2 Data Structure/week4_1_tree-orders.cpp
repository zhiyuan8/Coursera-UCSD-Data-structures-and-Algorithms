...
#endif
// refer from
// https://github.com/manparvesh/coursera-ds-algorithms/blob/master/2.%20Data%20Structures/Programming-Assignment-4/tree_orders/tree-orders.cpp
using namespace std;
...
class TreeOrders {
  ...
  public:
    ...
    void preorder_traversal(vector<int> &result, int i) {
        if (i == -1) return; // stop criteria: index == -1, reaches leaf node
        result.push_back(key[i]);
