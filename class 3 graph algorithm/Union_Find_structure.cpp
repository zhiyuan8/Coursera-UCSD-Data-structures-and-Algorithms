// refer from https://www.geeksforgeeks.org/union-find/
// disjoint set: https://www.tutorialspoint.com/cplusplus-program-to-implement-disjoint-set-data-structure
#include <iostream>
#include <vector>
...
void print(vector<int> const &vec, DisjointSet &disjoint_set) {
   for (int i : vec)
   cout << disjoint_set.Find(i) << " ";
   cout << '\n';
}
